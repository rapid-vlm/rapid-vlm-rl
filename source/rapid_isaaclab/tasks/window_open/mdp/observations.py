...
def rel_ee_window_distance(env: ManagerBasedRLEnv) -> torch.Tensor:
    """The distance vector from the end-effector to the window handle."""
    ee_tf_data: FrameTransformerData = env.scene["ee_frame"].data
    window_tf_data: FrameTransformerData = env.scene["window_frame"].data

    return window_tf_data.target_pos_w[..., 0, :] - ee_tf_data.target_pos_w[..., 0, :]
